...
4. Передать команде Flow учетные данные (логин/пароль) для приема заявок.
   ...
   **Шаг 2. Заполнить GUID программ**
   ...
   -  получить уникальный GUID программы с портала РР (для каждого региона, где опубликована программа, будет свой GUID - необходимо получить их все). Создать программу ->Сохранить-> в таблице программ первый столбец
