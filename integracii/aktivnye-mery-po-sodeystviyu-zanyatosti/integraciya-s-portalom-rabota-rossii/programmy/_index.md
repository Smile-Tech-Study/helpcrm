---
order: 1
title: "Настройка интеграции\_РР по программам"
---
...
4. Передать команде Flow учетные данные (логин/пароль) для приема заявок.
   ...
   **Шаг 2. Заполнить GUID программ**
   ...
   -  получить уникальный GUID программы с портала РР (для каждого региона, где опубликована программа, будет свой GUID - необходимо получить их все). Создать программу ->Сохранить-> в таблице программ первый столбец - это GUID (тут нужен скрин). [Подробнее](./kak-poluchit-guid-programmy-s-rr)

   -  открыть вкладку «Внешние источники» на странице программы во Flow и добавить  внешний источник «Guids программ с РР» ;

   ![](./_index-2.png){width=2886px height=1388px}

   -  после добавления внешнего источника  по кнопке «Редактировать» необходимо добавить полученные GUID программ (через запятую).

   ![](./_index.png){width=2878px height=1014px}
