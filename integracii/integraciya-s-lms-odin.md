...
![](./integraciya-s-lms-odin.png){width=2856px height=1406px}

В системе доступно массовое действие "Зарегистрировать в Odin». Для этого:

1\. Отфильтруйте заявки по необходимо признаку, например по потоку. 

2\. Отметьте галочками заявки (все заявки можно отметить, кликнув на галочку в заголовке) 

3\. Зарегистрируйте слушателей в Odin 

4\. Дождитесь завершения регистрации

![](./integraciya-s-lms-odin.jpg){width=1920px height=1201px}