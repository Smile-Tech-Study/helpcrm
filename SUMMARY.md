...
<div class="sd">
  ...
  <div class="sd-start">
    <div class="sd-start-label">Заявки, документы, зачисление — в одной системе
Flow помогает образовательным организациям вести слушателей от подачи заявки до выдачи документа. Онлайн-заявки, генерация договоров и приказов, интеграция с LMS Odin. </div>
