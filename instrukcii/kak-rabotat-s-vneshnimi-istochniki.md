...
## Копирование внешних источников

У короткого названия внешнего источника есть символы параграфа, как это сделано для ключевых слов дополнительных полей. Можно скопировать короткое название внешнего источника. Такая возможность есть в организации, программе, потоке.

При наведении на символ копирования выводится подсказка:

![](./kak-rabotat-s-vneshnimi-istochniki-8.png){width=279px height=166px}