...
8\.Если всё сделано верно, но при вводе кода появляется ошибка, проверьте время на телефоне и ПК, они должны быть верными. Если это не так, то установите верное время и повторите вход.
