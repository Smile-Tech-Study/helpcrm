...
-  доступно включение:
   ...
   -  [автоматического выпуска приказов](./../../obuchenie/prikaz/avtomaticheskii-vypusk)
...
Пропустите шаг 3, если [приказы](./../../obuchenie/prikaz/_index) не будут автоматически генерироваться во Flow.
...
Выбрать подходящую группу шаблонов будет возможно на странице [заявки](./../../slushateli/zayavki/sposoby-sozdaniya-zayavok/_index).
