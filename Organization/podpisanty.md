...
Выбрать пункт меню «Карточка организации», далее вкладка «Подписанты» - «Добавить подписанта».

![](./podpisanty.png){width=1469px height=651px}
...
![](./podpisanty-2.png){width=1282px height=519px}
