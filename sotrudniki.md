...
В системе предусмотрена работа с задачами на разных уровнях доступа.

**Просмотр.** Пользователь может видеть только задачи, исполнителем которых он назначен. Он не может создавать задачи для других пользователей.

**Редактирование.** Пользователю доступна кнопка "Создать задачу», видны только те задачи, автором или исполнителем которых он является. Сотрудник может редактировать только те задачи, автором которых он является.

**Задачи организации.** Пользователю доступно всё, в том числе доступна вкладка "Задачи организации".

![](./sotrudniki-5.png){width=1560px height=214px}

## Доступ к нескольким организациям

Один пользователь может иметь доступ к нескольким организациям под одним профилем.

-  Если данные пользователя отредактировали в одной организации, эти же изменения отобразятся в другой организации.

-  Для каждой организации у пользователя могут быть свои права (доступ к программам/потокам и т.д.).

-  При переключении между организациями пользователь получает функциональность согласно правам, назначенным для этой организации.