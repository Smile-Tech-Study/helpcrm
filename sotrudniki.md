...
Первый сотрудник организации регистрируется при подаче заявки на сайте <https://www.flow-crm.study/registrations>. \
Далее сотрудников следует добавить через Пользователи - Кнопка +
